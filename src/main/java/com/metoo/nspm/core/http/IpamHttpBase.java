...
@Component
public class IpamHttpBase {

    public String TOKEN = "kOlwKACYQ3KLFyQLiFSAPXIgzQVXZ6eb";
    public String BASE_URL = "https://192.168.5.112:1443/api/metoo";
    ...
    public IpamHttpBase(String url) {
        this.url = url;
    }

    public IpamHttpBase(String url, Map<String, Object> map) {
        this.url = url;
        this.map = map;
    }

    public IpamHttpBase(String url, String token, Map<String, Object> map) {
        this.url = url;
        this.map = map;
    }
